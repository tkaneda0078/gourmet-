...
<html>
  ...
  @media screen and (max-width: 485px) {
    ...
    .secondary-text-color {
      color: rgba(251, 83, 83, 1) !important;
    }
    ...
    .border-button {
      color: rgba(251, 83, 83, 1) !important;
      border-color: rgba(251, 83, 83, 1) !important;
    }
    .button {
      background-color: rgba(251, 83, 83, 1) !important;
  ...
  <body class="plain error-page-wrapper background-color background-image">
	...
	<div class="buttons-container">
		<?php echo Html::anchor('mylist', 'Go To Homepage', array('class' => 'border-button')); ?>
	</div>
</div>
